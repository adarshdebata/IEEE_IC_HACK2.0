    ...
    <header class="relative z-50 w-full h-24">
        <div
            ...
            <a href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                ...
                <span class="ml-3 text-xl text-gray-800">Medspace<span class="text-pink-500">.</span></span>
            </a>
    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">Your Health,
                    Our
                    Responsibility</h1>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">A comprehensive health app for tracking, advice, and personalized wellness, tailored to you.</p>
                <a href="#_"
    ...
    <div id="features" class="relative w-full px-8 py-10 border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            ...
            <h3
                ...
                Your Health, Your Choices, Your Journey</h3>
            <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Planner</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">A managing functionality for the mental as well as physical health and fitness.</p>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Self Evaluation</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">Self Evaluation of physical & mental health using machine learning.</p>
                        <a href="#_" class="relative flex mt-2 text-sm font-medium text-indigo-500 underline">Learn
                            More</a>
                    </div>
                </div>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Notifications/Alerts</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">Notifications for tasks & alerts for</p>
                        <a href="#_" class="relative flex mt-2 text-sm font-medium text-indigo-500 underline">Learn
                            More</a>
                    </div>
                </div>
                        ...
                        <div class="overflow-hidden text-black bg-white border-t border-gray-100 rounded-lg shadow-sm">
                            <div
                                ...
                                <h4
                                    ...
                                    <span class="mr-1 -ml-2 text-lg text-gray-700">Rs.</span>69</h4>
                    ...
                    <div
                        ...
                        <div class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-6">
                            ...
                            <h4
                                ...
                                <span class="mr-1 -ml-2 text-lg text-gray-700">Rs.</span>99</h4>
                    ...
                    <div
                        ...
                        <div class="overflow-hidden text-black bg-white rounded-lg shadow-lg shadow-inner">
                            <div
                                ...
                                <h4
                                    class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
                                    <span class="mr-1 -ml-2 text-lg text-gray-700">Rs.</span>199</h4>
